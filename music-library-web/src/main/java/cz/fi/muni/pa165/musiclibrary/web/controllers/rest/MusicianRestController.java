...
public class MusicianRestController {
	 ...
	 * <p>
	 * curl -i -X GET http://localhost:8080/pa165/rest/musician
	 *
	 * @return MusicianDTO
	 */
	 ...
	 * curl -i -X GET http://localhost:8080/pa165/rest/musician/1
	 *
	 ...
	 * curl -i -X DELETE http://localhost:8080/pa165/rest/musician/1
	 *
	 ...
	 * <p>
	 * curl -X POST -i -H "Content-Type: application/json" --data '{"name":"test"}' http://localhost:8080/pa165/rest/musician/create
	 *
	 ...
	 * curl -X PUT -i -H "Content-Type: application/json" --data '{"name":"UpdatedName"}' http://localhost:8080/pa165/rest/musician/1
	 *
